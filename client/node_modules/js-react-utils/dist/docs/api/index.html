...
<head>
	...
	<title>js-react-utils (version 0.0.85) | js-react-utils (version 0.0.85)</title>
	<meta name="description" content="Documentation for js-react-utils (version 0.0.85)">
		...
		<div class="container">
			<div class="table-wrap">
				<div class="table-cell">
					<strong><a href="index.html">js-react-utils (version 0.0.85)</a></strong>
				</div>
...
<div class="container container-main">
	<div class="content-wrap">
		<div class="tsd-panel tsd-typography">
			<a href="#js-react-utils" id="js-react-utils" style="color: inherit; text-decoration: none;">
				<h1>js-react-utils</h1>
			</a>
			<p>A bundle of opinionated utility functions for React.
			Currently the main purpose is to provide an alternative way to validate component props.</p>
			<a href="#usage-example" id="usage-example" style="color: inherit; text-decoration: none;">
				<h2>Usage example</h2>
			</a>
			<pre><code class="language-tsx"><span style="color: #AF00DB">import</span><span style="color: #000000"> </span><span style="color: #001080">React</span><span style="color: #000000">, { </span><span style="color: #001080">useCallback</span><span style="color: #000000">, </span><span style="color: #001080">useState</span><span style="color: #000000"> } </span><span style="color: #AF00DB">from</span><span style="color: #000000"> </span><span style="color: #A31515">&#039;react&#039;</span>
<span style="color: #AF00DB">import</span><span style="color: #000000"> { </span><span style="color: #001080">addComponentMeta</span><span style="color: #000000"> } </span><span style="color: #AF00DB">from</span><span style="color: #000000"> </span><span style="color: #A31515">&#039;js-react-utils&#039;</span>
<span style="color: #AF00DB">import</span><span style="color: #000000"> </span><span style="color: #0000FF">*</span><span style="color: #000000"> </span><span style="color: #AF00DB">as</span><span style="color: #000000"> </span><span style="color: #001080">Spec</span><span style="color: #000000"> </span><span style="color: #AF00DB">from</span><span style="color: #000000"> </span><span style="color: #A31515">&#039;js-spec/validators&#039;</span><span style="color: #000000"> </span><span style="color: #008000">// 3rd-party validation library</span>

<span style="color: #0000FF">type</span><span style="color: #000000"> </span><span style="color: #267F99">CounterProps</span><span style="color: #000000"> = {</span>
<span style="color: #000000">  </span><span style="color: #001080">initialValue</span><span style="color: #000000">?: </span><span style="color: #267F99">number</span>
<span style="color: #000000">  </span><span style="color: #001080">label</span><span style="color: #000000">?: </span><span style="color: #267F99">string</span>
<span style="color: #000000">}</span>

<span style="color: #AF00DB">export</span><span style="color: #000000"> </span><span style="color: #AF00DB">default</span><span style="color: #000000"> </span><span style="color: #0000FF">function</span><span style="color: #000000"> </span><span style="color: #795E26">Counter</span><span style="color: #000000">({</span>
<span style="color: #000000">  </span><span style="color: #001080">initialValue</span><span style="color: #000000"> = </span><span style="color: #098658">0</span><span style="color: #000000">,</span>
<span style="color: #000000">  </span><span style="color: #001080">label</span><span style="color: #000000"> = </span><span style="color: #A31515">&#039;Counter&#039;</span>
<span style="color: #000000">}: </span><span style="color: #267F99">CounterProps</span><span style="color: #000000">) {</span>
<span style="color: #000000">  </span><span style="color: #0000FF">const</span><span style="color: #000000"> [</span><span style="color: #0070C1">counter</span><span style="color: #000000">, </span><span style="color: #0070C1">setCounter</span><span style="color: #000000">] = </span><span style="color: #795E26">useState</span><span style="color: #000000">(</span><span style="color: #001080">initialValue</span><span style="color: #000000">)</span>
<span style="color: #000000">  </span><span style="color: #0000FF">const</span><span style="color: #000000"> </span><span style="color: #0070C1">onClick</span><span style="color: #000000"> = </span><span style="color: #795E26">useCallback</span><span style="color: #000000">(() </span><span style="color: #0000FF">=&gt;</span><span style="color: #000000"> </span><span style="color: #795E26">setCounter</span><span style="color: #000000">((</span><span style="color: #001080">it</span><span style="color: #000000">) </span><span style="color: #0000FF">=&gt;</span><span style="color: #000000"> </span><span style="color: #001080">it</span><span style="color: #000000"> + </span><span style="color: #098658">1</span><span style="color: #000000">), [])</span>

<span style="color: #000000">  </span><span style="color: #AF00DB">return</span><span style="color: #000000"> (</span>
<span style="color: #000000">    </span><span style="color: #800000">&lt;button</span><span style="color: #000000"> </span><span style="color: #FF0000">onClick</span><span style="color: #000000">=</span><span style="color: #0000FF">{</span><span style="color: #001080">onClick</span><span style="color: #0000FF">}</span><span style="color: #800000">&gt;</span>
<span style="color: #000000">      </span><span style="color: #0000FF">{</span><span style="color: #001080">label</span><span style="color: #0000FF">}</span><span style="color: #000000">: </span><span style="color: #0000FF">{</span><span style="color: #001080">count</span><span style="color: #0000FF">}</span>
<span style="color: #000000">    </span><span style="color: #800000">&lt;/button&gt;</span>
<span style="color: #000000">  )</span>
<span style="color: #000000">}</span>

<span style="color: #008000">// This will allow a run-time props validation that&#039;s</span>
<span style="color: #008000">// useful when the Counter component is used in JavaScript</span>
<span style="color: #008000">// instead of TypeScript.</span>
<span style="color: #0000FF">const</span><span style="color: #000000"> </span><span style="color: #0070C1">validateCounterProps</span><span style="color: #000000"> = </span><span style="color: #001080">Spec</span><span style="color: #000000">.</span><span style="color: #795E26">checkProps</span><span style="color: #000000">({</span>
<span style="color: #000000">  </span><span style="color: #001080">optional:</span><span style="color: #000000"> {</span>
<span style="color: #000000">    </span><span style="color: #001080">initialValue:</span><span style="color: #000000"> </span><span style="color: #001080">Spec</span><span style="color: #000000">.</span><span style="color: #001080">number</span><span style="color: #000000">,</span>
<span style="color: #000000">    </span><span style="color: #001080">label:</span><span style="color: #000000"> </span><span style="color: #001080">Spec</span><span style="color: #000000">.</span><span style="color: #001080">string</span>
<span style="color: #000000">  }</span>
<span style="color: #000000">})</span>

<span style="color: #795E26">addComponentMeta</span><span style="color: #000000">(</span><span style="color: #001080">Counter</span><span style="color: #000000">, {</span>
<span style="color: #000000">  </span><span style="color: #001080">name:</span><span style="color: #000000"> </span><span style="color: #A31515">&#039;Counter&#039;</span><span style="color: #000000">,</span>
<span style="color: #000000">  </span><span style="color: #001080">validation:</span>
<span style="color: #000000">    </span><span style="color: #001080">process</span><span style="color: #000000">.</span><span style="color: #001080">env</span><span style="color: #000000">.</span><span style="color: #0070C1">NODE_ENV</span><span style="color: #000000"> === (</span><span style="color: #A31515">&#039;development&#039;</span><span style="color: #000000"> </span><span style="color: #AF00DB">as</span><span style="color: #000000"> </span><span style="color: #267F99">string</span><span style="color: #000000">) &amp;&amp; </span><span style="color: #001080">validateCounterProps</span>
<span style="color: #000000">})</span>
</code></pre>
			...
			<ul>
				<li><p>Support for framework agnostic props validation.
					...
					Instead a general and more sophisticated validation library like for example <a href="https://github.com/js-works/js-spec">js-spec</a> can be used.</p>
				</li>
				<li><p>Some additional useful helper functions.</p>
				</li>
			</ul>
			<a href="#project-status" id="project-status" style="color: inherit; text-decoration: none;">
				<h2>Project status</h2>
			</a>
			<p>This project is in alpha state.</p>
		</div>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-module"><a href="modules/addComponentMeta.html" class="tsd-kind-icon">add<wbr>Component<wbr>Meta</a></li>
							<li class="tsd-kind-module"><a href="modules/isElement.html" class="tsd-kind-icon">is<wbr>Element</a></li>
							<li class="tsd-kind-module"><a href="modules/isElementOfType.html" class="tsd-kind-icon">is<wbr>Element<wbr>OfType</a></li>
							<li class="tsd-kind-module"><a href="modules/isNode.html" class="tsd-kind-icon">is<wbr>Node</a></li>
							<li class="tsd-kind-module"><a href="modules/isRef.html" class="tsd-kind-icon">is<wbr>Ref</a></li>
							<li class="tsd-kind-module"><a href="modules/withChildren.html" class="tsd-kind-icon">with<wbr>Children</a></li>
						</ul>
					</section>
				</div>
			</section>
